...
//		Clickonelement(pom.getschedloc().getproselected());
		...
		Clickonelement(pom.getschedloc().getselectmonday());

		// Select Tuesday

		Clickonelement(pom.getschedloc().getselecttuesday());
...
//		Thread.sleep(5000);
//
//		WebDriverWait tod = new WebDriverWait(driver, 10);
//		WebElement selt = tod
//				.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[normalize-space()='Today'])[1]")));
//		((JavascriptExecutor) driver).executeScript("arguments[0].click();", selt);

		// Clickonelement(pom.getschedloc().getcalto());
		// Select calender
...
//		Clickonelement(pom.getschedloc().getfacilityselect());
//
//		Clickonelement(pom.getschedloc().getfacilityselect1());

		// provider
//
//		Thread.sleep(3000);
//		Clickonelement(pom.getschedloc().getprosel1());
//
//		Clickonelement(pom.getschedloc().getproselected1());
// close repeats
...
/////////// Appointment Dashboard ///////
		...
		try {
			...
			selectone(pom.getschedloc().getshstse(), "Arrived");
		} catch (Exception e1) {
			// TODO Auto-generated catch block
		...
		sendkeys(pom.getschedloc().getClickcalender(), "06-02-2023");
...
//		 Clickonelement(pom.getschedloc().getClickcalender());
		...
		try {
			...
			// TODO Auto-generated catch block
			System.out.println("Status select Tele");
		}
		...
		sendkeys(pom.getschedloc().getClickcalender1(), "06-02-2023");
...
//		js.executeScript(“document.getElementByID("(//input[@name='timeapp'])[1]").value = "1056";");
		...
		// send time
		Thread.sleep(4000);
		sendkeys(pom.getschedloc().getapptimer(), "1120");
...
//		// Click Time
//
//		sendkeys1(pom.getschedloc().getexamrroom(), Keys.TAB);
//
//		// send time
//		Thread.sleep(4000);
//		sendkeys(pom.getschedloc().getapptimer(), "10:56");

		// send time
//		Clickonelement(pom.getschedloc().getapptimer());

//		// identify element
//		WebElement l = driver.findElement(By.xpath("//input[@value='10:11']"));
//
//		// Javascript executor
